...
def select_story_batch(
    *,
    ...
    for story in stories:
        ...
        # story_paths is None when story has no projected work items yet.
        # That story should be handled by decomposition / projection, not story execution.
