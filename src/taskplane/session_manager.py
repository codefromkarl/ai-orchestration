...
class InMemorySessionManager:
    ...
    policy_resolutions_by_session_id: dict[str, list[PolicyResolutionRecord]] = field(
        default_factory=dict
    )
    ...
    def create_session(
        ...
        *,
        ...
        with self._lock:
            ...
            self.policy_resolutions_by_session_id[session_id] = []
        return session
    ...
    def record_policy_resolution(
        ...
        *,
        ...
        with self._lock:
            ...
            records = self.policy_resolutions_by_session_id.setdefault(session_id, [])
    ...
    def get_latest_policy_resolution(
        ...
        records = self.policy_resolutions_by_session_id.get(session_id, [])
    ...
    def build_resume_context(self, session_id: str) -> str:
        ...
        if checkpoints:
            ...
            if last_ckpt.failure_context:
                parts.append(
                    "Failure context: "
                    + json.dumps(last_ckpt.failure_context, ensure_ascii=False)
                )
        return "\n".join(parts)
