...
_console_read_api = import_module("stardrifter_orchestration_mvp.console_read_api")
_console_actions = import_module("stardrifter_orchestration_mvp.console_actions")
_governance_priority_api = import_module(
    "stardrifter_orchestration_mvp.governance_priority_api"
)
_governance_health = import_module("stardrifter_orchestration_mvp.governance_health")
_orphan_coordinator = import_module("stardrifter_orchestration_mvp.orphan_coordinator")
_auto_split_trigger = import_module("stardrifter_orchestration_mvp.auto_split_trigger")
_governance_decision_engine = import_module(
    "stardrifter_orchestration_mvp.governance_decision_engine"
)
