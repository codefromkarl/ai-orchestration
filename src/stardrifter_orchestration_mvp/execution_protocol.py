...
# -----------------------------------------------------------------------
EXECUTION_RESULT_MARKER = "STARDRIFTER_EXECUTION_RESULT_JSON="

# -----------------------------------------------------------------------
# Intermediate execution markers (Phase A)
# -----------------------------------------------------------------------
EXECUTION_CHECKPOINT_MARKER = "STARDRIFTER_EXECUTION_CHECKPOINT_JSON="
EXECUTION_WAIT_MARKER = "STARDRIFTER_EXECUTION_WAIT_JSON="
EXECUTION_RETRY_INTENT_MARKER = "STARDRIFTER_EXECUTION_RETRY_INTENT_JSON="
